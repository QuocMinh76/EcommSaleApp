    ...
    public class LoginModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var userInfo = _db.ApplicationUsers.FirstOrDefault(c => c.UserName.ToLower() == Input.UserName.ToLower());
                    var roleInfo = (from u in _db.UserRoles
                                    join r in _db.Roles on u.RoleId equals r.Id
                                    where u.UserId == userInfo.Id
